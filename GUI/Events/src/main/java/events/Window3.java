    ...
    private void mouseListener(){
        ...
        MouseListener mouseListener = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.isAltDown()){
                    textArea.append("alt + click pressed\n");
                }
                else if (e.isControlDown()){
                    textArea.append("ctrl + click pressed\n");
                }
                else if (e.isShiftDown()){
                    textArea.append("shift + click pressed\n");
                }
                else if (e.isMetaDown()){ // MetaDown works when you do a right click
                    textArea.append("right click\n");
                }
                else{
                    textArea.append("Normal click\n");
                }
                
                if(e.getClickCount() == 2){
                    textArea.append("Doble Click\n");
                }
            }
